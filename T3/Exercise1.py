#Create a class to represent a person. The class should have the following attributes: name, surname, age, address, and phone number. It should also have the following methods:
